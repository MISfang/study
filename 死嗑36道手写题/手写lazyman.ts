...
//   eat(food: string) {
//     const cb = () => {
//       console.log('%c 🥓 `${this.name}吃了${food}`: ', 'font-size:20px;background-color: #EA7E5C;color:#fff;', `${this.name}吃了${food}`);
//       this.next()
//     }
//     this.cbs.push(cb)
//     return this
...
//   sleep(time: number) {
//     const cb = () => {
//       console.log('%c 🥓 `${this.name}吃了${food}`: ', 'font-size:20px;background-color: #EA7E5C;color:#fff;', `${this.name}开始睡觉，${time}秒`);
//       setTimeout(() => {
//         console.log('%c 🥓 `${this.name}吃了${food}`: ', 'font-size:20px;background-color: #EA7E5C;color:#fff;', `${this.name}睡觉结束`);
//         this.next()
//       }, time * 1000)
//     }
//     this.cbs.push(cb)
